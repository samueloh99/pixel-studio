...
export function Benefits() {
  return (
    <div className="w-full flex h-full py-[200px] bg-gray-300">
      <div className="container flex flex-col justify-center items-center h-full gap-40">
        ...
        <div className="grid grid-cols-3 w-full h-[300px] gap-5 justify-center">
          ...
          <div className="flex flex-col items-center justify-center text-center gap-3 w-3/4 h-full m-auto">
            ...
            <p className="text-sm h-full">
              Experience designs crafted to perfection in record time—typically
              in just a few days.
            </p>
          </div>
          <div className="flex flex-col items-center justify-center text-center gap-3 w-3/4 h-full m-auto">
          ...
          <div className="flex flex-col items-center justify-center text-center gap-3 w-3/4 h-full m-auto">
            ...
            <p className="text-sm h-full">
              Whether scaling up or pausing, our services flex to fit your
              needs. Adapt as you grow.
            </p>
          </div>
          <div className="flex flex-col items-center justify-center text-center gap-3 w-3/4 h-full m-auto">
