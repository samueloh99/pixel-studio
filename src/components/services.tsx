...
export function Services() {
  return (
    <div className="flex flex-col border border-black p-5 justify-center items-center h-full py-[200px] gap-20">
      <div className="flex flex-col border border-black justify-center items-center h-full gap-20 w-full">
      ...
      <div className="flex flex-col border border-black p-5 justify-center items-center h-full gap-20 w-full">
        <div className="flex flex-col items-center justify-center text-center w-full md:w-2/5 gap-5">
