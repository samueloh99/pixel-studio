    ...
    <div className="flex flex-col justify-center items-center h-full py-[200px] gap-20">
      <div className="flex flex-col items-center justify-center text-center w-full md:w-2/5 gap-5">
        ...
        <p className="font-normal text-sm">
          From Concept to Launch <br /> Our workflow is designed to keep you in
      ...
      <div className="flex flex-col gap-5 justify-center items-stretch w-full h-full text-center">
        <div className="flex flex-col gap-2 w-full h-full justify-start items-center rounded-md py-5">
          ...
          <p className="font-thin text-md italic">Understanding Your Vision</p>
          <p className="text-sm w-1/2">
            Our initial step is to delve deep into your goals, objectives, and
            aspirations. We set dedicated sessions to understand the nuances of
            your needs, ensuring we lay a strong foundation for the project.
          </p>
        </div>
